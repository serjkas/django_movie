# Generated by Django 3.1.4 on 2020-12-20 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='сумма в долларах', verbose_name='Сброы в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='сумма в долларах', verbose_name='Сброы в мире')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movie.Actor', verbose_name='Дректор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='фильм', to='movie.movie')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='звезда', to='movie.ratingstar')),
            ],
            options={
